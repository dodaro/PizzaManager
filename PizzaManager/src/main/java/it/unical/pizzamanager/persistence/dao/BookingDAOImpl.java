...
public class BookingDAOImpl implements BookingDAO {
	...
	// TODO nel caso in cui DODARO dice che servono quei metodi mi basta
	// sostituire order con booking nelle sottostanti funzioni
	...
	// Session session = databaseHandler.getSessionFactory().openSession();
	//
	// String queryString = "from Order where date = :date_order and time =
	// :time_order";
	// Query query = session.createQuery(queryString);
	// query.setParameter("date_order", date);
	...
	//
	// String queryString = "from Order where date = :date_order and time =
	// :time_order and priority = :priority_order";
	// Query query = session.createQuery(queryString);
	// query.setParameter("date_order", date);
	// query.setParameter("time_order", time);
	...
	// Session session = databaseHandler.getSessionFactory().openSession();
	//
	// String queryString = "from Order where date = :date_order and priority =
	// :priority_order";
	// Query query = session.createQuery(queryString);
	// query.setParameter("date_order", date);
	// query.setParameter("priority_order", priority);
