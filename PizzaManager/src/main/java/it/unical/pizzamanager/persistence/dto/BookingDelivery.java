...
public class BookingDelivery extends Booking{
	...
	public BookingDelivery(Date date, Date time, Boolean confirmed,Person person, Payment payment,Integer priority, Date estimatedDeliveryTime, String addressToDelivery/*, ArrayList<OrderItems> orderItems, Pizzeria pizzeria*/) {
