...
public class BookingTablePizzeria extends Booking{
	...
	public BookingTablePizzeria(Date date, Date time, Boolean confirmed,Person person, Payment payment,Integer priority, ArrayList<RelationTableBookingTablePizzeria> tablebooking/*, ArrayList<OrderItems> orderItems, Pizzeria pizzeria*/) {
