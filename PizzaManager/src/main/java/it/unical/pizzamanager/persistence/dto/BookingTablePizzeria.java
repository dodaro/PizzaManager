...
public class BookingTablePizzeria extends Booking{
	...
	public BookingTablePizzeria(Date date, Date time, Boolean confirmed,Person person, Payment payment,Integer priority, ArrayList<RelationTableBookingTablePizzeria> tablebooking/*, ArrayList<OrderItems> orderItems, Pizzeria pizzeria*/, ArrayList<OrderItem> orderItems, Pizzeria pizzeria) {
	...
	//FUNZIONE: dammi tutti i tavoli relativi ad una prenotazione di tavolo "tb"
	//facendo il getRelationTableBookingTablePizzeria avrò già solo la lista di tutti i tavoli relativi alla prenotazione
