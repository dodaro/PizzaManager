					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#${b.identifier}">
									${b.pizzeria} </a>
						...
						<div id="${ b.identifier}" class="panel-collapse collapse bubble">
							<ul class="list-group">
								...
								<c:forEach var="i" varStatus="Istatus" items="${b.items}">
									<li class="list-group-item row"><b class="col-xs-3">${i.itemName} </b><b
										class="col-xs-3"> ${i.number} </b><b class="col-xs-3"> ${i.getCostLabel()} &#8364</b><b
										class="pull-right">${i.getTotal()} &#8364</b></li>
								</c:forEach>
								<li class="list-group-item"><b>Total Book</b> <b class="pull-right">${b.performTotal()}
										&#8364</b></li>
							</ul>
