...
<head>
	...
	<script type="text/javascript" class="init">
		...
		$(document).ready(function() {
			...
			$('#suca').click( function () {
		        var pilloscia=table.row('.selected').data();
		        alert(pilloscia.time);
...
<body>
	...
	<div>
		<button id="suca" type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
		  Launch demo modal
		</button>
