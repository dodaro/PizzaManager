...
public class BookingPopulator extends Populator {
	...
	protected void populate() {
		...
		ingredientsAdded.add(new RelationPizzaOrderItemIngredient(RelationPizzaOrderItemIngredient.ADDITION, pizzeriaDAO.getAll().get(0).getIngredientsPriceList().get(7).getIngredient(), pizzaOrder2));
